                ...
                <div class="container">
                    <div class="header-wrap d-none d-lg-flex">
                        <div class="logo logo-width-1">
                            <a href="/"><img src="{{asset('assets/imgs/logo/new-logo2.png')}}" id ="logo_id" alt="logo"></a>
                        </div>
                                    ...
                                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                                        <nav>
                                            <ul>
                                                ...
                                                @auth
                                                <li><a href="#">حساب تجارى<i class="fi-rs-angle-down"></i></a>
                                                        @if (Auth::user()->utype == 'ADM')
                                                            <ul class="sub-menu">
                                                                {{-- <li><a href="{{ route('admin.dashboard') }}"> Dashboard</a></li> --}}
                                                                <li><a href="{{ route('admin.products') }}">المنتجات</a></li>
                                                                <li>
                                                                    <a href="{{ route('admin.stores') }}">المتاجر</a>
                                                                </li>
                                                                <li><a href="{{ route('admin.categories') }}">مجموعات المنتجات</a>
                                                                </li>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="widget-about font-md mb-md-5 mb-lg-0">
                                    <div class="logo logo-width-1 wow fadeIn animated">
                                        <a href="#"><img class="bottomlogo" src="{{asset('assets/imgs/logo/new-logo2.png')}}" id ="logo_id" alt="logo"></a>
                                    </div>
