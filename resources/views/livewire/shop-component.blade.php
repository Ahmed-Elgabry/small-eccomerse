                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> ستجدنا <strong class="text-brand">{{ $products->total() }}</strong> عروض المنتجات بالنسبة لك
                                </p>
                            </div>
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    <div class="sort-by-product-wrap">
                                        ...
                                        <div class="sort-by-dropdown-wrap">
                                            <span> الترتيب الافتراضى <i class="fi-rs-angle-small-down"></i></span>
                                        </div>
                                    </div>
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy == 'Default Sorting' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Default Sorting')">الترتيب الافتراضى</a></li>
                                            ...
                                            <li><a class="{{ $pageSize == 'Sort By  Newness' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Sort By  Newness')">الترتيب حسب الحداثة</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title mb-10">تصفية حسب السعر</h5>
                                    ...
                                    <div class="price_slider_amount">
                                        <div class="label-input">
                                            <span>Range:</span><span><span
                                                    class="text-info">${{ $min_value }}</span> - <span
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            ...
                            <div class="banner-text">
                                <span>منطقة المرأة</span>
                                <h4>خصم 17% على <br> مكياج الصحة والجمال</h4>
