                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p>لقد وجدت <strong class="text-brand">{{ $products->total() }}</strong> المنتج النموذجي بالنسبة لك <strong class="text-brand">{{ $category_name }}</strong> فئة!</p>
                            </div>
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    <div class="sort-by-product-wrap">
                                        <div class="sort-by">
                                            <span><i class="fi-rs-apps"></i>مشاهده:</span>
                                        </div>
                                ...
                                <div class="sort-by-cover">
                                    <div class="sort-by-product-wrap">
                                        ...
                                        <div class="sort-by-dropdown-wrap">
                                            <span> ترتيب افتراضي <i class="fi-rs-angle-small-down"></i></span>
                                        </div>
                                    </div>
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy == 'Default Sorting' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Default Sorting')">الترتيب الافتراضي</a></li>
                                            <li><a class="{{ $pageSize == 'Price: Low to High' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Price: Low to High')">السعر من الارخص للاعلى</a></li>
                                            <li><a class="{{ $pageSize == 'Price: High to Low' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Price: High to Low')">السعر الاعلى الى الادنى</a></li>
                                            <li><a class="{{ $pageSize == 'Sort By  Newness' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Sort By  Newness')">ترتيب حسب الحداثة</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            @foreach ($products as $product)
                                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <img class="hover-img"src="{{ $product->store->image }}"
                                         alt="{{ $product->name }}">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                            ...
                            <div class="list-group">
                                <div class="list-group-item mb-10 mt-10">
                                    ...
                                    <div class="custome-checkbox">
                                        ...
                                        <label class="form-check-label" for="exampleCheckbox3"><span>ارق
                                                (54)</span></label>
                                    </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title mb-10">منتجات جديده</h5>
                                <div class="bt-1 border-color-1"></div>
                            </div>
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            ...
                            <div class="banner-text">
                                ...
                                <h4>وفر 17% على <br> مكياج الصحة والجمال</h4>
