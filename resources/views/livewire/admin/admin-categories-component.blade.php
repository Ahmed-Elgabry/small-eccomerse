                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ route('admin.category.add') }}"
                                            class="btn btn-success float-end">إضافه مجموعه جديده</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
            ...
            <div class="modal-body pb-30 pt-30">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4 class="pb-3">هل تريد حذف هذا العنصر؟</h4>
                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                            data-bs-target="#deleteConfirmation">الغاء</button>
