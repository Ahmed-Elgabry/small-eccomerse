                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            ...
                                            <div class="product-badges product-badges-position product-badges-mrg">
                                                <span class="hot" style='background-color: #7ac4ef;'>الاعلى تقييما</span>
                                            </div>
                                        </div>
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a href="#">{{ $topProduct->category->name }}</a>
                                            </div>
                                            <h2><a href="#">{{ $topProduct->name }}</a></h2>
                                            <div class="rating-result" title="{{ $topProduct->rating }}%">
                                                <span>
                                                    <span>{{ $topProduct->rating }}%</span>
                                                </span>
                                            </div>
                                            <div class="product-price">
                                                <span>{{ $topProduct->sale_price }} </span>
                                                <span class="old-price">{{ $topProduct->regular_price }} </span>
                                            </div>
                                             <div style="color: #F15412;font-weight: bold;">
                                                {{ $newProduct->discount_code }}
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            <span class="hot">الاعلى تقييما</span>
                                        </div>
                                    </div>
                                    <div class="product-content-wrap">
                                        <div class="product-category">
