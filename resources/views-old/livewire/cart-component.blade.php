        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> عربة التسوق الخاصة بك
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-end">
                                                <a href="#" class="text-muted" wire:click.prevent="clearAll()"> <i
                                                        class="fi-rs-cross-small"></i> سلة التسوق</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            @else
                                <p>لا يوجد عنصر في السلة</p>
                            @endif
                        </div>
                        <div class="cart-action text-end">
                            <a class="btn  mr-10 mb-sm-15"><i class="fi-rs-shuffle mr-10"></i>تحديث عربة التسوق</a>
                            <a class="btn "><i class="fi-rs-shopping-bag mr-10"></i>مواصلة التسوق</a>
                        </div>
                        ...
                        <div class="row mb-50">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-12">
                                            <button class="btn  btn-sm"><i
                                                    class="fi-rs-shuffle mr-10"></i>تحديث</button>
                                        </div>
                                    </div>
                                </form>
                                            ...
                                            <div class="coupon">
                                                <form action="#" target="_blank">
                                                    <div class="form-row row justify-content-center">
                                                        ...
                                                        <div class="form-group col-lg-6">
                                                            <button class="btn  btn-sm"><i
                                                                    class="fi-rs-label mr-10"></i>يتقدم بطلب</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="cart_total_label">الضرائب</td>
                                                    <td class="cart_total_amount"><span
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"> <i class="ti-gift mr-5"></i> ًالشحن مجانا</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <a href="#" class="btn "> <i class="fi-rs-box-alt mr-10"></i>
                                        انتقل إلى الخروج</a>
                                </div>
                            </div>
                        </div>
